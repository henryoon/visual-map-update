...
int main(int argc, char** argv)
{
    ...
    if(pcl::io::loadPCDFile<pcl::PointXYZRGB>("/home/irol/catkin_ws/src/pcd_publisher/pcd_file/global_1116_good.pcd", *original_cloud) == -1)
    {
    ...
    *filtered_cloud = *original_cloud;  // Copy the original point cloud to the filtered point cloud
    ...
    // float selected_point_y2 = 1.5;  
    // float selected_point_z2 = 0.65;  
    ...
    float z_range = 0.4;  // The range around the z-coordinate to filter out
